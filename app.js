...
app.get('/user', passportConfig.isAuthenticated, userController.getAccount);
...
app.post('/user/delete', passportConfig.isAuthenticated, userController.postDeleteAccount);
